        ...
        <div class="grid gap-8 lg:grid-cols-3">
            <div class="lg:col-span-2">
                ...
                <div class="card-elevated overflow-hidden">
                    <div class="relative bg-gradient-to-bl from-primary-950 via-primary-800 to-primary-900 px-6 py-8 sm:px-8">
                        ...
                        <div class="relative flex flex-col items-center gap-6 sm:flex-row sm:items-end">
                            <div class="relative shrink-0">
                                <x-doctor-photo :doctor="$doctor" size="profile" class="ring-4 ring-white/30 shadow-2xl" />
                                @if ($doctor->is_vip)
                                    <span class="badge-vip absolute -top-2 start-1/2 -translate-x-1/2 shadow-lg">VIP</span>
                                @endif
                            </div>
                        ...
                        <div class="border-t border-slate-100 px-6 py-7 sm:px-8">
                            ...
                            <div class="space-y-4">
                                @foreach ($doctor->reviews as $review)
                                    <blockquote class="rounded-2xl border border-slate-100 bg-gradient-to-l from-slate-50 to-white p-5 shadow-sm">
